...
const float ACCELERATION_HORIZONTAL = 0.15f;
const float MAX_VELOCITY_HORIZONTAL = 3.0f;
const float MAX_VELOCITY_VERTICAL = 3.0f;
const float FRICTION_COEFFICIENT_ACC = 3.0f;
const float FRICTION_COEFFICIENT_DEC = 0.2f;

// Rotation constants
const float ANGULAR_ACCELERATION_X = 0.3f; 
const float ANGULAR_ACCELERATION_Z = 0.15f;
const float MAX_ROT_X = 0.5f; 	
const float MAX_ROT_Z = 0.75f;	
const float ANGULAR_FRICTION_ACC = 0.95f;
const float ANGULAR_FRICTION_DEC = 0.5f;
