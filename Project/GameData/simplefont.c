...
// modern code, and a bit better! Nice new features: Placement
// relative to bottom or right (negative coordinates), smarter
// left edge clipping.
// font.c was CAPITAL LETTERS only, but here lower case is added,
// and numbers, and some more!
...
// 2022: Removed need for sfSetRasterSize and sfMakeRasterFont. Simplest case: Just draw!
// Cleaned up some dead code. Resolved a number of warnings.

// By Ingemar Ragnemalm 2009-2022. This is free software.
...
static GLuint sfMakeRasterFont(void)
{
	GLint tex;
	GLint saveprogram;
